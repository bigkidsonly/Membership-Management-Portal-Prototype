...
export function BenefitsPanel() {
  ...
  const [benefits, setBenefits] = useState<(typeof benefits)[]>(
    (initialBenefits as benefits[]) || []
  );

  useEffect(() => {
    if (!benefitsLoading && initialBenefits) {
      setBenefits(initialBenefits as benefits[]);
    }
  }, [benefitsLoading]);
