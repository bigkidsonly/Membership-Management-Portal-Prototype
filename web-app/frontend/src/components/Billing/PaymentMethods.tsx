...
export function PaymentMethods({
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 transform transition-all duration-300 hover:shadow-xl">
          ...
          <div
            ...
            className={`border rounded-lg p-4 transition-all duration-300 ${
              method.isPrimary
                ...
                : hoverCard === method.id
                ? "border-primary/20 bg-gray-50 shadow-md scale-[1.01]"
                : "border-gray-200 hover:border-primary/20 hover:bg-gray-50 hover:shadow-sm"
            }`}
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-900">
                    ...
                    {method.isPrimary && (
                      <span className="ml-2 text-xs bg-primary/10 text-primary px-2 py-0.5 rounded-full shadow-sm">
                        Primary
                      </span>
                    )}
                  </p>
              ...
              <div className="flex space-x-2">
                {!method.isPrimary && (
                  <button
                    ...
                    className="text-sm text-primary hover:text-primary/80 flex items-center transition-all duration-200 hover:bg-primary/10 px-2 py-1 rounded-md"
                  >
      ...
      {isAddingNew ? (
        <div className="mt-5 border rounded-lg p-5 border-primary/20 bg-primary/5 shadow-lg">
          ...
          <div className="mb-5 border-b border-gray-200 pb-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              >
                <CheckSquare
                  className={`w-6 h-6 mb-2 ${
                    paymentType === "check" ? "text-primary" : "text-gray-500"
                  }`}
                />
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-primary focus:border-primary shadow-sm transition-shadow duration-200 hover:shadow"
                />
              </div>
              ...
              <div className="flex items-center mt-3">
                <div className="flex-shrink-0 mr-3">
                  <img
                    src="https://cdn.pixabay.com/photo/2021/12/06/13/08/stripe-6850391_960_720.png"
                    alt="Stripe"
        ...
        <button
          ...
          className="mt-5 w-full flex items-center justify-center px-4 py-3 border border-gray-200 rounded-lg text-sm font-medium text-primary hover:bg-primary/5 transition-all duration-200 hover:border-primary/20 shadow-sm hover:shadow-md hover:-translate-y-0.5 transform"
        >
      ...
      <div className="mt-6 pt-5 border-t border-gray-200">
        <button
          ...
          className="text-sm font-semibold text-primary flex items-center hover:underline mb-3"
        >
          {showPaymentInfo
        ...
        {showPaymentInfo && (
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 space-y-4 shadow-inner">
            <div>
