...
import { MembershipApplication } from "../components/Affiliates/MembershipApplication";
import { Affiliate } from "../types/affiliate";
import { Plus, Filter, Search, FileText } from "lucide-react";
import { affiliates as affiliatesData } from "@/data/affiliatesOrganization";
...
export function Affiliates() {
  ...
  const [isMembershipApplicationOpen, setIsMembershipApplicationOpen] =
    useState(false);
  ...
  // Handler for membership application submission
  const handleMembershipApplication = (applicationData: any) => {
    // Handle the membership application submission
  ...
  useEffect(() => {
    fetch("/api/organization/all-affiliates")
    ...
    <div className="max-w-7xl mx-auto">
      ...
      {isMembershipApplicationOpen && (
        <MembershipApplication
          onSubmit={handleMembershipApplication}
          onCancel={() => setIsMembershipApplicationOpen(false)}
        />
      )}
    </div>
  );
